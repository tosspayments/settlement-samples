...
<%
  ...
  String parameters = "?startDate=" + startDate + "&endDate=" + endDate + "&page=" + pages +  "&size=" + size;
  
  URL url = new URL("https://api.tosspayments.com/v1/settlements"+ parameters);
    ...
    if (isSuccess) { %>
        ...
        <%
            ...
            while (i.hasNext()) {
                ...
                out.println("soldDate : " + transaction.get("soldDate") + "<br>");
                out.println("payOutAmount : " + transaction.get("payOutAmount") + "<br>");
                out.println("paidOutDate : " + transaction.get("paidOutDate") + "<br>");
